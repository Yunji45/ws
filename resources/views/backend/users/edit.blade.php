...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="/users/{{$data->id}}/update" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="password" id="password" value="{{ old('password', $data->password ?? '')}}">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
