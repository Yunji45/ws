...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{route('proyek.save')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="phone" class="form-control" name="telp" id="telp">
                                </div>
                            </div>
                            @for ($i = 1; $i <= 10; $i++)
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="bar_progress" id="bar_progress">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
