                        ...
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="nama_produk" id="nama_produk" value="{{ old('nama_produk', $data->nama_produk ?? '')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="file" class="form-control" name="foto_produk" id="foto_produk" value="{{ old('foto_produk', $data->foto_produk ?? '')}} onchange="previewimage()">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
